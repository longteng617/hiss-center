 ...
 **/
@Component
public class PD_ProcessBisStartDesignHandler implements CmdHandler<ProcessDesignModelMessage> {
    ...
    @Override
    public String getId() {
        return HandlerIdClientEnum.PD_FLOW_M_START_MODEL_FOR_BIS.getId();
    }
}
