...
@Component
@Slf4j
public class SYS_ProcessInstanceDeleteHandler implements CmdHandler<ProcessInstanceMessage> {
    @Autowired
    ...
    @Override
    public String getId() {
        return HandlerIdClientEnum.SYS_PROCESS_INSTANCE_DELETE.getId();
    }
}
