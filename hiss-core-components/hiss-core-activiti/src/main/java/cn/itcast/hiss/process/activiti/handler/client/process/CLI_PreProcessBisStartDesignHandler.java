 ...
 **/
@Component
public class CLI_PreProcessBisStartDesignHandler implements CmdHandler<ProcessDesignModelMessage> {
    ...
    @Override
    public String getId() {
        return HandlerIdClientEnum.CLI_FLOW_M_PRE_START_MODEL_FOR_BIS.getId();
    }
}
