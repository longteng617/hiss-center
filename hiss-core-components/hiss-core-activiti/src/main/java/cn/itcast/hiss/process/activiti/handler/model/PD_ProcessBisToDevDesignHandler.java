...
/*
 * @author miukoo
 * @description 业务人员流程转为开发模式
 * @date 2023/5/25 16:26
 * @version 1.0
 **/
@Component
public class PD_ProcessBisToDevDesignHandler  implements CmdHandler<ProcessDesignModelMessage> {
    ...
    public void invoke(Message message, MessageContext messageContext) {
        activitiDesignerService.convertToDev((ProcessDesignModelMessage) message,messageContext);
    }

    @Override
    public String getId() {
        return HandlerIdClientEnum.PD_FLOW_M_TODEV_MODEL_FOR_BIS.getId();
    }
}
