...
@Slf4j
@Data
public class HissRemoteMessageThrowingEventListener extends MessageThrowingEventListener {
    @Autowired
    ...
    public void onEvent(ActivitiEvent event) {
        if (isValidEvent(event)) {
            ...
            HissActivitiEvent hissActivitiEvent = HissActivitiEventBuilder.builder()
                    ...
                    .activitiEvent(event)
                    .build();
            hissActivitiEvent.setOperationType(EventOperationTypeEnum.MESSAGE_EVENT_NOTICE);
