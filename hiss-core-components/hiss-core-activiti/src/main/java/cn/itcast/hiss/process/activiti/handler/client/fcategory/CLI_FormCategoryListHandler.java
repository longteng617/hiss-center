package cn.itcast.hiss.process.activiti.handler.client.fcategory;
...
@Component
@Slf4j
public class CLI_FormCategoryListHandler implements CmdHandler<ProcessCategoryMessage> {
    ...
    @Override
    public String getId() {
        return HandlerIdClientEnum.CLI_FORM_CATEGORY_LIST.getId();
    }
}
