...
/*
 * @author miukoo
 * @description 查询业务流程设计get
 * @date 2023/5/25 16:26
 * @version 1.0
 **/
@Component
public class PD_ProcessBisGetDesignHandler  implements CmdHandler<ProcessDesignModelMessage> {
    @Autowired
    ...
    @Override
    public String getId() {
        return HandlerIdClientEnum.PD_FLOW_M_GET_MODEL_FOR_BIS.getId();
    }
}
